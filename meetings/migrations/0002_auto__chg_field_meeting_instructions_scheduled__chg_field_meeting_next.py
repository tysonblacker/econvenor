...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.instructions_scheduled'
        db.alter_column(u'meetings_meeting', 'instructions_scheduled', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.next_meeting_instructions'
        db.alter_column(u'meetings_meeting', 'next_meeting_instructions', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.apologies'
        db.alter_column(u'meetings_meeting', 'apologies', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.attendance'
        db.alter_column(u'meetings_meeting', 'attendance', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.instructions_actual'
        db.alter_column(u'meetings_meeting', 'instructions_actual', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.location_scheduled'
        db.alter_column(u'meetings_meeting', 'location_scheduled', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.location_actual'
        db.alter_column(u'meetings_meeting', 'location_actual', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Meeting.next_meeting_location'
        db.alter_column(u'meetings_meeting', 'next_meeting_location', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Meeting.instructions_scheduled'
        db.alter_column(u'meetings_meeting', 'instructions_scheduled', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.next_meeting_instructions'
        db.alter_column(u'meetings_meeting', 'next_meeting_instructions', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.apologies'
        db.alter_column(u'meetings_meeting', 'apologies', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.attendance'
        db.alter_column(u'meetings_meeting', 'attendance', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.instructions_actual'
        db.alter_column(u'meetings_meeting', 'instructions_actual', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.location_scheduled'
        db.alter_column(u'meetings_meeting', 'location_scheduled', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.location_actual'
        db.alter_column(u'meetings_meeting', 'location_actual', self.gf('django.db.models.fields.TextField')(max_length=200))

        # Changing field 'Meeting.next_meeting_location'
        db.alter_column(u'meetings_meeting', 'next_meeting_location', self.gf('django.db.models.fields.TextField')(max_length=200))
