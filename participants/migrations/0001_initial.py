...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'participants_participant', (
            ...
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('reminders', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='Active', max_length=20, blank=True)),
        ))
        db.send_create_signal(u'participants', ['Participant'])


    def backwards(self, orm):
        # Deleting model 'Participant'
        db.delete_table(u'participants_participant')
