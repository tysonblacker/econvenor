...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.first_name'
        db.alter_column(u'participants_participant', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Participant.last_name'
        db.alter_column(u'participants_participant', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Participant.notes'
        db.alter_column(u'participants_participant', 'notes', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Participant.first_name'
        db.alter_column(u'participants_participant', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Participant.last_name'
        db.alter_column(u'participants_participant', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Participant.notes'
        db.alter_column(u'participants_participant', 'notes', self.gf('django.db.models.fields.TextField')(max_length=300))
