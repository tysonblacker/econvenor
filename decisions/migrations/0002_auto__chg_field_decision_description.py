...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Decision.description'
        db.alter_column(u'decisions_decision', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Decision.description'
        db.alter_column(u'decisions_decision', 'description', self.gf('django.db.models.fields.TextField')(max_length=300))
