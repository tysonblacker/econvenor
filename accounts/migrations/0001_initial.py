...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_usersettings', (
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('current_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Group'])),
        ))
        db.send_create_signal(u'accounts', ['UserSettings'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_usersettings')
