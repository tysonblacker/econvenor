...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.join_date'
        db.delete_column(u'core_account', 'join_date')

        # Adding field 'Account.date_altered'
        db.add_column(u'core_account', 'date_altered',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 1, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Account.join_date'
        db.add_column(u'core_account', 'join_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Account.date_altered'
        db.delete_column(u'core_account', 'date_altered')
