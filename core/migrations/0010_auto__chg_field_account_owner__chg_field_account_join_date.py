...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_account', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Account.join_date'
        db.alter_column(u'core_account', 'join_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Account.owner'
        db.alter_column(u'core_account', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'Account.join_date'
        db.alter_column(u'core_account', 'join_date', self.gf('django.db.models.fields.DateField')(default=1))
