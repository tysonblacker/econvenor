...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.explainer'
        db.alter_column(u'core_item', 'explainer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Participant'], null=True))

    def backwards(self, orm):

        # Changing field 'Item.explainer'
        db.alter_column(u'core_item', 'explainer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Participant']))
