...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.owner'
        db.add_column(u'core_meeting', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Participant.owner'
        db.add_column(u'core_participant', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Item.owner'
        db.add_column(u'core_item', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Decision.owner'
        db.add_column(u'core_decision', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Task.owner'
        db.add_column(u'core_task', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.owner'
        db.delete_column(u'core_meeting', 'owner_id')

        # Deleting field 'Participant.owner'
        db.delete_column(u'core_participant', 'owner_id')

        # Deleting field 'Item.owner'
        db.delete_column(u'core_item', 'owner_id')

        # Deleting field 'Decision.owner'
        db.delete_column(u'core_decision', 'owner_id')

        # Deleting field 'Task.owner'
        db.delete_column(u'core_task', 'owner_id')
