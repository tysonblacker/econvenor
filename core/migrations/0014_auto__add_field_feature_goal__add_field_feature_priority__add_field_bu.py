...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feature.goal'
        db.add_column(u'core_feature', 'goal',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Feature.priority'
        db.add_column(u'core_feature', 'priority',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Bug.priority'
        db.add_column(u'core_bug', 'priority',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feature.goal'
        db.delete_column(u'core_feature', 'goal')

        # Deleting field 'Feature.priority'
        db.delete_column(u'core_feature', 'priority')

        # Deleting field 'Bug.priority'
        db.delete_column(u'core_bug', 'priority')
