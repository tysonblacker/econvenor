...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.start_time'
        db.add_column(u'core_meeting', 'start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meeting.notes'
        db.add_column(u'core_meeting', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.start_time'
        db.delete_column(u'core_meeting', 'start_time')

        # Deleting field 'Meeting.notes'
        db.delete_column(u'core_meeting', 'notes')
    ...
    models = {
        ...
        u'core.account': {
            ...
            'date_altered': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'core.item': {
            ...
            'explainer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Participant']", 'null': 'True', 'blank': 'True'}),
            'heading': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Meeting']"}),
            'minute_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'time_limit': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
