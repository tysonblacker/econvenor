...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.agenda_locked'
        db.add_column(u'core_meeting', 'agenda_locked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Task.status'
        db.alter_column(u'core_task', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'Meeting.agenda_locked'
        db.delete_column(u'core_meeting', 'agenda_locked')


        # Changing field 'Task.status'
        db.alter_column(u'core_task', 'status', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'core.meeting': {
            ...
            'agenda_locked': ('django.db.models.fields.BooleanField', [], {}),
