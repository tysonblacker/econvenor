...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feature.date'
        db.alter_column(u'core_feature', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 1, 9, 0, 0)))

        # Changing field 'Bug.date'
        db.alter_column(u'core_bug', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 1, 9, 0, 0)))

    def backwards(self, orm):

        # Changing field 'Feature.date'
        db.alter_column(u'core_feature', 'date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Bug.date'
        db.alter_column(u'core_bug', 'date', self.gf('django.db.models.fields.DateField')(null=True))
