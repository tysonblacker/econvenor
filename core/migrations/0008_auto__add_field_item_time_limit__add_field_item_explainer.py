...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.time_limit'
        db.add_column(u'core_item', 'time_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding field 'Item.explainer'
        db.add_column(u'core_item', 'explainer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Participant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.time_limit'
        db.delete_column(u'core_item', 'time_limit')

        # Deleting field 'Item.explainer'
        db.delete_column(u'core_item', 'explainer_id')
