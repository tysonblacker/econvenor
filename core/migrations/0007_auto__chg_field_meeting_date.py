...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.date'
        db.alter_column(u'core_meeting', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Meeting.date'
        db.alter_column(u'core_meeting', 'date', self.gf('django.db.models.fields.DateTimeField')())
