...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'docs_item', (
            ...
            ('explainer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['participants.Participant'], null=True, blank=True)),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetings.Meeting'], null=True, blank=True)),
            ('added_in_meeting', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('background', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
            ('carry_over', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('item_no', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('minute_notes', self.gf('django.db.models.fields.TextField')(max_length=2000, blank=True)),
            ('time_limit', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'docs', ['Item'])

        # Adding model 'Template'
        db.create_table(u'docs_template', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Group'])),
        ...
        db.send_create_signal(u'docs', ['Template'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'docs_item')

        # Deleting model 'Template'
        db.delete_table(u'docs_template')
