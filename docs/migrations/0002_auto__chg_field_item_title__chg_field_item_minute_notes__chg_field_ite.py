...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'docs_item', 'title', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Item.minute_notes'
        db.alter_column(u'docs_item', 'minute_notes', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Item.background'
        db.alter_column(u'docs_item', 'background', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Item.title'
        db.alter_column(u'docs_item', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Item.minute_notes'
        db.alter_column(u'docs_item', 'minute_notes', self.gf('django.db.models.fields.TextField')(max_length=2000))

        # Changing field 'Item.background'
        db.alter_column(u'docs_item', 'background', self.gf('django.db.models.fields.TextField')(max_length=1000))
