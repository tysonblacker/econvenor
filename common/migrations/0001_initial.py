...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Update'
        db.create_table(u'common_update', (
            ...
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['participants.Participant'])),
        ...
        db.send_create_signal(u'common', ['Update'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'common_update')
    ...
    models = {
        ...
        u'common.accountupdate': {
            'Meta': {'object_name': 'AccountUpdate'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
