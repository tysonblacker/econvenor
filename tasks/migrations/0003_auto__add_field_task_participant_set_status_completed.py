...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.participant_set_status_completed'
        db.add_column(u'tasks_task', 'participant_set_status_completed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.participant_set_status_completed'
        db.delete_column(u'tasks_task', 'participant_set_status_completed')
    ...
    models = {
        ...
        u'tasks.task': {
            ...
            'participant_set_status_completed': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
