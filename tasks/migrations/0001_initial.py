...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tasks_task', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['docs.Item'], null=True, blank=True)),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetings.Meeting'], null=True, blank=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['participants.Participant'], null=True)),
            ...
            ('notes', self.gf('django.db.models.fields.TextField')(max_length=300, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='Incomplete', max_length=10, blank=True)),
            ('task_no', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
