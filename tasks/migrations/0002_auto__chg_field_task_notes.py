...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.notes'
        db.alter_column(u'tasks_task', 'notes', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Task.notes'
        db.alter_column(u'tasks_task', 'notes', self.gf('django.db.models.fields.TextField')(max_length=300))
