...
urlpatterns = patterns('',
	...
	url(r'^landing/faqs/$', 'landing.views.faqs', name="landing-faqs"),
	url(r'^landing/terms/$', 'landing.views.terms', name="landing-terms"),
	url(r'^landing/project/$', 'landing.views.project', name="landing-project"),
	url(r'^landing/contact/$', 'landing.views.contact', name="landing-contact"),
	url(r'^landing/volunteer/$', 'landing.views.volunteer', name="landing-volunteer"),
	url(r'^landing/donate/$', 'landing.views.donate', name="landing-donate"),
